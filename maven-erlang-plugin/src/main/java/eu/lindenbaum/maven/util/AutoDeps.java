...
public class AutoDeps {
  ...
  public void addAll(List<Artifact> artifacts) throws MojoExecutionException {
    for (Artifact artifact : artifacts)
      this.add(artifact.getArtifactId());
  }
   ...
   * @throws MojoExecutionException
   */
  public List<Artifact> analyze() throws MojoExecutionException {
    ...
    while (iter.hasNext()) {
      ...
      result.add(MavenUtils.getArtifact(details.getName(), details.getVersion()));
    }
